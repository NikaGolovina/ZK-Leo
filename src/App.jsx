...
import "./App.css";
import leo_program from "../helloworld/build/main.aleo?raw";
...
function App() {
  ...
  async function execute() {
    setExecuting(true);
    const result = await aleoWorker.localProgramExecution(leo_program, "main", [
      "5u32",
      "5u32",
    ]);
    setExecuting(false);
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(leo_program);
